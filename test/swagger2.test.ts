  ...
  describe('other output', () => {
    ...
    it('generates the example output correctly', () => {
      ...
      const output = readFileSync(
        resolve(__dirname, '..', 'example', 'output.d.ts'),
        'UTF-8'
      );
